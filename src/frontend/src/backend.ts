...
export class Backend implements backendInterface {
    ...
    async clearUserData(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearUserData(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteApiCredentials(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteApiCredentials();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteBotConfig(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteBotConfig(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllTradingHistory(): Promise<Array<[Principal, Array<TradeRecord>]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllTradingHistory();
    ...
    async getAllUserBotConfigs(): Promise<Array<[Principal, Array<BotConfig>]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllUserBotConfigs();
    ...
    async getBotConfigs(): Promise<Array<BotConfig>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBotConfigs();
    ...
    async getTradingHistory(): Promise<Array<TradeRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTradingHistory();
    ...
    async getUserTradingHistory(arg0: Principal): Promise<Array<TradeRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserTradingHistory(arg0);
                return from_candid_vec_n5(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasApiCredentials(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasApiCredentials();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: OrderRequest): Promise<string> {
        if (this.processError) {
            try {
    ...
    async saveBotConfig(arg0: BotConfig): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveBotConfig(to_candid_BotConfig_n27(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBotConfig(arg0: bigint, arg1: BotConfig): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBotConfig(arg0, to_candid_BotConfig_n27(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_BotMode_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _BotMode): BotMode {
    return from_candid_variant_n18(_uploadFile, _downloadFile, value);
}
function from_candid_BotType_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _BotType): BotType {
...
function from_candid_opt_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_MacdRsiBotConfig]): MacdRsiBotConfig | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_GridBotConfig]): GridBotConfig | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_opt_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_BotType]): BotType | null {
    return value.length === 0 ? null : from_candid_BotType_n9(_uploadFile, _downloadFile, value[0]);
}
function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    emaScalpingConfig: [] | [_EmaScalpingBotConfig];
    mode: _BotMode;
    botType: _BotType;
    riskManagement: _RiskManagement;
    macdRsiConfig: [] | [_MacdRsiBotConfig];
    gridConfig: [] | [_GridBotConfig];
}): {
    emaScalpingConfig?: EmaScalpingBotConfig;
    mode: BotMode;
    botType: BotType;
    ...
    return {
        emaScalpingConfig: record_opt_to_undefined(from_candid_opt_n16(_uploadFile, _downloadFile, value.emaScalpingConfig)),
        mode: from_candid_BotMode_n17(_uploadFile, _downloadFile, value.mode),
        botType: from_candid_BotType_n9(_uploadFile, _downloadFile, value.botType),
...
function from_candid_record_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        side: value.side,
        botType: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.botType)),
...
function from_candid_tuple_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [Principal, Array<_BotConfig>]): [Principal, Array<BotConfig>] {
    return [
        value[0],
        from_candid_vec_n13(_uploadFile, _downloadFile, value[1])
    ];
}
function from_candid_tuple_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [Principal, Array<_TradeRecord>]): [Principal, Array<TradeRecord>] {
    return [
        value[0],
...
function from_candid_variant_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "grid" in value ? BotType.grid : "emaScalping" in value ? BotType.emaScalping : "macdRsi" in value ? BotType.macdRsi : value;
}
...
function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[Principal, Array<_BotConfig>]>): Array<[Principal, Array<BotConfig>]> {
    return value.map((x)=>from_candid_tuple_n12(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_BotConfig>): Array<BotConfig> {
    return value.map((x)=>from_candid_BotConfig_n14(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[Principal, Array<_TradeRecord>]>): Array<[Principal, Array<TradeRecord>]> {
    return value.map((x)=>from_candid_tuple_n4(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_TradeRecord>): Array<TradeRecord> {
    return value.map((x)=>from_candid_TradeRecord_n6(_uploadFile, _downloadFile, x));
}
function to_candid_BotConfig_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: BotConfig): _BotConfig {
...
function to_candid_variant_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: BotType): {
    ...
    return value == BotType.grid ? {
        grid: null
    } : value == BotType.emaScalping ? {
        emaScalping: null
